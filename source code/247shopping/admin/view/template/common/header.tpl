...
<div id="header">
  <div class="div1">
    <div class="div2"><img class="logo-h35" src="view/image/logo.png" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /></div>
    <?php if ($logged) { ?>
    ...
    <ul class="left" style="display: none;">
      ...
      <li id="extension"><a class="top"><?php echo $text_extension; ?></a>
        <ul>
          ...
          <li><a href="<?php echo $section; ?>"><?php echo $text_section; ?></a></li>
          <li><a href="<?php echo $news; ?>"><?php echo $text_news; ?></a></li>
          <li><a href="<?php echo $news_review; ?>"><?php echo $text_news_review; ?></a></li>
