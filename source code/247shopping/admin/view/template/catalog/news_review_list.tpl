          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($review['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $review['news_review_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $review['news_review_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $review['title']; ?></td>
