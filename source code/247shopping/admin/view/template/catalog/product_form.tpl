                        ...
                        <div id="language<?php echo $language['language_id']; ?>">
                            <table class="form">
                                ...
                                <tr>
                                    ...
                                    <td><textarea name="product_description[<?php echo $language['language_id']; ?>][featured]" id="featured<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['featured'] : ''; ?></textarea></td>
                                </tr>
                                <tr>
...
<?php foreach ($languages as $language) { ?>
              CKEDITOR.replace('featured<?php echo $language['language_id']; ?>', {
