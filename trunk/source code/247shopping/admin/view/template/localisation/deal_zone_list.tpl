        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'z.code') { ?>
                ...
                <?php } ?></td>
              <td class="right"><?php if ($sort == 'z.sort_order') { ?>
                ...
                <?php } ?></td>
              <td class="right"><?php if ($sort == 'z.status') { ?>
                <a href="<?php echo $status; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_status; ?></a>
                <?php } else { ?>
                <a href="<?php echo $status; ?>"><?php echo $column_status; ?></a>
                <?php } ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right"><?php echo $zone['sort_order']; ?></td>
              <td class="right"><?php echo $zone['status']; ?></td>
